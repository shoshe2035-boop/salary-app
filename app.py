...
<style>
    ...
    @media print {
        ...
        .printable-report { border: 2px solid #000 !important; box-shadow: none; }
    }
</style>
...
def calculate_employee(emp):
    ...
    for i, act in enumerate(actions):
        ...
        # تعديل تاريخ البدء إذا كان اليوم >= 25
        start = act['date']
        if start.day >= 25:
            # الانتقال إلى أول الشهر التالي
...
if st.session_state.all_employees:
    ...
    if st.button("🖨️ طباعة الكشوفات", use_container_width=True):
